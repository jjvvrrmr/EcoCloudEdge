...
[![ArgoCD](https://img.shields.io/badge/GitOps-ArgoCD-orange?logo=argo)](http://localhost:8080)
[![k3s](https://img.shields.io/badge/Kubernetes-k3s-blue?logo=kubernetes)](https://k3s.io)
[![Sealed Secrets](https://img.shields.io/badge/Secrets-SealedSecrets-green?logo=bitwarden)](https://github.com/bitnami-labs/sealed-secrets)
